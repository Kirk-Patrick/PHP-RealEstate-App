                ...
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        <div style="margin-left:2%;color:#ff0000">
                            <label id="val_firstname">
                                <?php if($regValObj!=null) echo htmlentities($regValObj->firstNameErr); ?>
                            </label>
                        </div>
                        <div style="margin-left:2%;margin-top:30px ;color:#ff0000">
                            <label id="val_lastname">
                                <?php if($regValObj!=null) echo htmlentities($regValObj->lastNameErr); ?>
                            </label>
                        </div>
                        <div style="margin-left:2%;margin-top:30px;color:#ff0000">
                            <label id="val_telephone">
                                <?php if($regValObj!=null) echo htmlentities($regValObj->telephoneNumberErr); ?>
                            </label>
                        </div>
                        <div style="margin-left:2%;margin-top:25px;color:#ff0000">
                            <label id="val_email">
                                <?php if($regValObj!=null) echo htmlentities($regValObj->emailErr); ?>
                            </label>
                        </div>
                        <div style="margin-left:2%;margin-top:25px;color:#ff0000">
                            <label id="val_trn">
                                <?php if($regValObj!=null) echo htmlentities($regValObj->trnErr); ?>
                            </label>
                        </div>
                        <div style="margin-left:2%;margin-top:20px;color:#ff0000">
                            <label id="val_password">
                                <?php if($regValObj!=null) echo htmlentities($regValObj->passwordErr); ?>
                            </label>
                        </div>
                    </div>
                </div>
